...
class TravelViewModel:BaseViewModel() {
    ...
    private val _nowViewPagerPage = MutableLiveData<Int>(0)
    val nowViewPagerPage:LiveData<Int> = _nowViewPagerPage
    ...
    fun setNowViewPager(page:Int){
        _nowViewPagerPage.value = page
    }
}